# Как промптить видео-модели

> Техники Replicate по промптингу видео-моделей, 2025–2026. Текст оставлен на
> английском без правок.
>
> Параметры и ограничения нашей модели — [`seedance-2.5.md`](seedance-2.5.md).
